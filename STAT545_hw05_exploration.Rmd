...
Let's make an addition to gapminder that has countries which have a space program that have achieved space flight.
...
B <- A %>% mutate(fct_collapse("High_gdpPercap" = 
                                       c("National Center of Space Research", 
                                         "Italian Space Agency", 
                                         "Japan Aerospace Exploration Agency", 
                                         "National Aeronautics and Space Administration"
                                       )
...
ggplot(C, aes(gdpPercap, space_agency)) + geom_count()
